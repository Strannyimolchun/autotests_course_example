...
def repeats(our_str: str):
    """После каждой буквы переданной строки, добавляет постфикс '_n', где 'n' - это счетчик именно такой буквы
    :param our_str: строка, в которую нужно добавить счетчики"""

    new_str = ''
    letter_dict = {}

    for letter in our_str:
        new_str += f'{letter}_{letter_dict.setdefault(letter, 0) + 1}'
