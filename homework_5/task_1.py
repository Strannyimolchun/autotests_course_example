...
def letter_stat(our_str: str):
    """Из переданной строки создает словарь, где ключ - буква, а значение - количество ее вхождений в строке
    :param our_str: строка, из которой нужно составить словарь"""

    letter_lst = list(our_str)
    letter_dict = {letter: letter_lst.count(letter) for letter in set(letter_lst)}
