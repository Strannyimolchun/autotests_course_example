...
class PersonInfo:
    ...
    def __init__(self, name: str, age: int, *division):
        self.name = name
        self.age = age
    ...
    def new_salary(self):
        ...
        entering_count = Counter(''.join(self.division))
        sum_popular = sum([j[1] for j in entering_count.most_common(3)])
        return 1337 * self.age * sum_popular
